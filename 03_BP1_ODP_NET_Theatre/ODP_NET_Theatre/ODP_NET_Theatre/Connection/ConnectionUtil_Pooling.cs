...
namespace ODP_NET_Theatre.ConnectionPool
{
    public class ConnectionUtil_Pooling : IDisposable
    {
        ...
        public static IDbConnection GetConnection()//konekcija
        {
            if (instance == null || instance.State == System.Data.ConnectionState.Closed)
            {
                OracleConnectionStringBuilder ocsb = new OracleConnectionStringBuilder();
                ocsb.DataSource = Connection.ConnectionParams.LOCAL_DATA_SOURCE;//ovde vrv ce biti samo data ili tako nes
